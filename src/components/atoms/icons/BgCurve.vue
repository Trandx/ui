<template>
  ...
  <svg viewBox="0 0 596 170" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M596 0H0V170C0 170 100.904 132.865 176.753 130.805C250.021 128.816 282.857 155.099 355.988 158.032C451.47 161.861 596 133.498 596 133.498V0Z"
      fill="#1F2937"
    />
  </svg>
</template>
