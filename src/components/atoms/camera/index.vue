<template>
  <div class="border-2 border-primary-500 rounded-lg grid grid-cols-1 content-between">
    <div class="bg-primary-500 h-full flex justify-between items-center py-0.5 space-x-2 px-1">
      ...
      <div class="text-white text-lg" v-if="showStream">
        <button
          ...
          class="px-2 py-1 bg-red-500 hover:bg-red-400 focus:bg-red-400 rounded-lg"
          title="stop stream"
        >
    ...
    <div class="w-full flex justify-center items-center">
      ...
      <div
        v-else-if="error"
        class="text-3xl py-4 text-gray-600 flex items-center justify-center flex-col"
      >
        <div></div>
    ...
    <div class="bg-secondary-500 h-[40px] rounded-b-lg px-2">
      <div v-if="showStream" class="flex justify-center items-center h-full">
        <button
          class="bg-primary-500 hover:bg-gray-600 hover:text-white flex items-center p-2.5 rounded-full"
