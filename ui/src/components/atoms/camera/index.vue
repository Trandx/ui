    ...
    <div class="border-2 border-primary-400 rounded-lg  grid grid-cols-1 content-between">
        <div class="bg-primary-400 h-full flex justify-between items-center py-0.5 space-x-2 px-1">
            ...
            <div class="text-white text-lg border-2 border-white rounded-lg" v-else>
                <button @click.prevent="toggle"
                    class="px-2 py-0.5 bg-primary-400 hover:bg-primary-300 focus:bg-primary-300 rounded-lg"
                    title="play stream">
        ...
        <div class=" bg-secondary-400 h-[40px] rounded-b-lg  px-2">
            <div v-if="showStream" class="flex justify-center items-center h-full">
                <button class="bg-primary-400 hover:bg-gray-600 hover:text-white flex items-center p-2.5 rounded-full"
            ...
            <div v-if="isPhotoTaken" class="flex flex-wrap justify-between items-center h-full">
                <div class="flex justify-between w-auto space-x-4">
                    <button title="back to cameras"
                        class="bg-gray-400 hover:bg-primary-400 hover:text-white  flex items-center p-1 rounded-full"
                ...
                <div class="flex justify-end space-x-6 px-3">
                    ...
                    <div class="flex justify-center space-x-2">
                        ...
                        <button
                            class="bg-gray-400 hover:bg-primary-400 hover:text-white  flex items-center px-1.5  rounded-full"
                    ...
                    <div class="flex justify-center space-x-2">
                        <button
                            class="bg-gray-400 hover:bg-primary-400 hover:text-white  flex items-center px-1 rounded-full"
                            @click.prevent="reset">
