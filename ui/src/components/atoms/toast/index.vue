<template>
  <!-- Toast -->
    <Teleport :to="'#'+(teleportName || 'toastTeleport')">
      <div id="dismiss-toast" :class="`${!open && 'hidden'} transition duration-300 w-full max-w-xs bg-white border border-gray-200 rounded-xl shadow-lg `" role="alert">
        <div class="flex p-2">
