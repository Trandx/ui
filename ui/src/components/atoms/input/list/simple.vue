<template>
    <div
        class="text-white bg-gray-800 divide-y-2 divide-gray-800 overflow-y-auto max-h-[calc(50vh-100px)] scrollbar-w-[5px]  scrollbar-thin scrollbar-thumb-primary-400 hover:scrollbar-thumb-primary-400 scrollbar-track-slate-600"
        ref="itemList"
    >
      <div
